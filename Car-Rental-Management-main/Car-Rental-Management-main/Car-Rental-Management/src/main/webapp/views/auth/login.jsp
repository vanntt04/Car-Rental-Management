        ...
        <body>
            <div class="login-container">
                ...
                <c:if test="${not empty verifyMessage}">
                    <div class="error-message" style="background:#e0f2fe;border-left-color:#0284c7;color:#0f172a;">
                        ${verifyMessage}
                    </div>
                </c:if>

                <c:if test="${param.success == 'registered'}">
                    <div class="error-message" style="background:#ecfdf3;border-left-color:#22c55e;color:#14532d;">
                ...
                <form method="POST" action="${pageContext.request.contextPath}/login">
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="text" id="emailOrUsername" name="emailOrUsername" class="form-control" placeholder="Nhập email hoặc tên đăng nhập" value="${emailOrUsername}" required autofocus>
                        </div>
                    </div>
