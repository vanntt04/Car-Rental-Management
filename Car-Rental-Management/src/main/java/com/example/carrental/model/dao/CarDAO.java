...
public class CarDAO {
    ...
    /** Sort: date_desc (m?i nh?t), date_asc (c? nh?t). Status: null/empty = t?t c?. activeFilter: null/empty = t?t c?, "1" = còn ho?t ??ng, "0" = ng?ng ho?t ??ng */
    ...
    /** ??m s? xe c?a owner (có th? l?c theo status và active) */
    ...
    /**
     * L?y xe theo ch? s? h?u (owner) - không phân trang (gi? cho t??ng thích)
     */
    ...
    /**
     * L?y t?t c? các xe (dùng n?i b?, không l?c active)
     */
    ...
    /**
     * L?y danh sách xe còn ho?t ??ng (cho khách xem danh sách công khai)
     */
