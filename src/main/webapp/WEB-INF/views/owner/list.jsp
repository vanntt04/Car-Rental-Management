...
<html lang="vi">
    <head>
        ...
        <style>
            ...
            .list-toolbar a.btn-link.active {
                background: var(--woox-primary);
                color: #fff;
            }
            .pagination-wrap {
                display: flex;
        ...
        <jsp:include page="../layout/header.jsp"><jsp:param name="page" value="owner"/></jsp:include>
            ...
            <section class="woox-section">
                <div class="container">
                    <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px; margin-bottom: 28px;">
                        ...
                        <span style="display: flex; gap: 10px; flex-wrap: wrap;">
                            <span class="border-button"><a href="${ctx}/owner?action=bankAccount"><i class="bi bi-bank"></i> Tài khoản ngân hàng</a></span>
                            <span class="main-button"><a href="${ctx}/owner?action=new"><i class="bi bi-plus-lg"></i> Thêm xe mới</a></span>
                        </span>
                </div>
                <div class="list-toolbar">
                    ...
                    <button type="button" onclick="applyFilter()" class="btn-link">
                ...
                <c:if test="${not empty cars}">
                    ...
                    <a href="${ctx}/owner?page=1&keyword=${param.keyword}&status=${param.status}&sort=newest"
                       class="btn-link ${sortBy == 'newest' ? 'active' : ''}">
                        Mới nhất
                    </a>

                    <a href="${ctx}/owner?page=1&keyword=${param.keyword}&status=${param.status}&sort=oldest"
                       class="btn-link ${sortBy == 'oldest' ? 'active' : ''}">
                        Cũ nhất
                    </a>
                </div>
                            ...
                            <c:forEach var="car" items="${cars}">
                                <tr>
                                    ...
                                    <td style="text-align: right;">
                                        <a href="${ctx}/owner?action=detail&id=${car.id}" style="margin-right: 10px;" title="Xem"><i class="bi bi-eye"></i></a>
                                        <a href="${ctx}/owner?action=edit&id=${car.id}" style="margin-right: 10px;" title="Sửa"><i class="bi bi-pencil"></i></a>
