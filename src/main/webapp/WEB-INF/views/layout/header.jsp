...
<c:set var="isCustomer" value="${roleUp == 'CUSTOMER'}"/>
<header class="header-area ${isOwnerOrAdmin ? 'header-owner' : ''}">
    <div class="container">
        <nav class="main-nav">
            ...
            <ul class="nav" id="mainNav">
                ...
                <c:choose>
                    <c:when test="${isOwnerOrAdmin}">
                        <li><a href="${ctx}/owner" class="${param.page == 'owner' ? 'active' : ''}">Quản lý xe</a></li>
                        <li><a href="${ctx}/owner/bookings">Yêu cầu đặt xe</a></li>
                        <li><a href="${ctx}/searchcar" class="btn-book">Đặt xe ngay</a></li>
                    </c:when>
                    <c:otherwise>
                        <li><a href="${ctx}/searchcar" class="${param.page == 'cars' ? 'active' : ''}">Danh sách xe</a></li>
                        <li><a href="${ctx}/home#about">Về chúng tôi</a></li>
                        <li><a href="${ctx}/searchcar" class="btn-book">Đặt xe ngay</a></li>
                        <c:if test="${isCustomer}">
                            <li><a href="${ctx}/mybooking" class="${param.page == 'mybooking' ? 'active' : ''}">Đơn của tôi</a></li>
                        </c:if>
                    </c:otherwise>
                </c:choose>
            </ul>
